...
/* ==========================================================================
   ...
   Its own file, and its own place on the page: it sits under the visual style
   because that is what it overrides. Buried at the bottom of the free-text
   prompt it read as a footnote to a description, when it is in fact the one
   control that overrules the palette chosen a step earlier.
   ========================================================================== */
