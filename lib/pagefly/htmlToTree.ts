...
export const ASK = [
  ...
  "    Read the step, not the milliseconds.",
  "",
  ...
  "",
  "  Those nine words are the whole vocabulary — `fade`, `fade-up`,",
  "  `slide-left`, `slide-right`, `zoom`, and `float`, `shadow`, `grow`,",
  "  `glow`, `float-shadow`, `grow-shadow`. A motion outside them is left out",
  "  rather than approximated with the nearest one.",
  "",
