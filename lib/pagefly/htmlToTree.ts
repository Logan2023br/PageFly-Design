...
const ASK = [
  ...
  "",
  "  Three more parts, and the last two are the thumbnail strip:",
  "",
  "    counter        the `01 / 06` badge some galleries put in the corner of",
  "                   the photograph INSTEAD of dots. Writing it switches the",
  "                   dots off and has the badge built — the platform has no",
  "                   such setting, so a mockup that pages by number MUST say",
  "                   so here or the number is lost and dashes appear.",
  "    thumb          one tile in the strip. Its `aspectRatio` above all: the",
  "                   default is a square and a mockup with wide thumbnails",
  "                   arrives cropped without this.",
  "    thumbSelected  the chosen tile — the border the mockup draws on it.",
  "",
  "  `mediaThumbs` is a NUMBER on the product node, not a part: how many",
  "  thumbnails are visible at once. Count them in the mockup. Four wide tiles",
  "  is a different composition from the platform's default of five, and five",
  "  is what arrives if you stay silent.",
  "",
